                ...
                <div class="col-md-2">
                    <div class="container_2">     
                        <div id="mySidenav" class="sidenav">
                            ...
                            <a href="#" id="side7">Modify Student</a>
                        </div>                  
                    </div>
                </div>
                <div class="col-md-9" style="background-color:  rgba(44, 62, 80,0.7);">
                <div class="panel-heading text-center" style="background-color:  rgba(44, 62, 80,0.7);"><h3 class='student_view_header'> Student Database Catalog </h3> </div>
                <iframe src="Student_stuff/index.php" width="101%" height="90%"></iframe>
